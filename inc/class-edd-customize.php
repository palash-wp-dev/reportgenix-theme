...
if (!class_exists('Xgenious_EDD_Customize')){
	class Xgenious_EDD_Customize{
		//$instance variable
		private static $instance;
		
		public function __construct() {
			//refresh cart after new item added in cart
			add_action('wp_ajax_xgenious_cart_load',array($this,'cart_item_refresh'));
			add_action('wp_ajax_nopriv_xgenious_cart_load',array($this,'cart_item_refresh'));
			//remove decimal
...
//			add_filter( 'edd_purchase_link_defaults', array($this,'purchase_link_customize') );
	...
	if ( class_exists('Xgenious_EDD_Customize')){
		Xgenious_EDD_Customize::getInstance();
	}
}