...
if ( !class_exists('Xgenious_Group_Fields_Value') ){

	class Xgenious_Group_Fields_Value{
		/*
			* $instance
			* @since 1.0.0
			* */
	   ...
	   * */
		...
		public static function page_layout($prefix){
			...
			$return_var['content_column_class'] = $return_var['sidebar_enable'] ? 'col-lg-9' :'col-lg-12';
			$return_var['sidebar_column_class'] = 'col-lg-3';
		...
		public static function page_container($prefix,$type){
			...
			if ( 'container_options' == $type ){
				...
				$return_var['page_container_class'] = 'container container_1430';
		...
		public static function get_404_options_value(){
			...
			$return_val['title'] = cs_get_option('404_title') ? cs_get_option('404_title') : esc_html__('404','xgenious');;
			$return_val['subtitle'] = cs_get_option('404_subtitle') ? cs_get_option('404_subtitle') : esc_html__('Oops! That page can&rsquo;t be found.','xgenious');;
			$return_val['subtitle'] = cs_get_option('404_paragraph') ? cs_get_option('404_paragraph') : esc_html__('It looks like nothing was found at this location. Maybe try one of the links below or a search?','xgenious');
			$return_val['btn_text'] = cs_get_option('404_button_text') ? cs_get_option('404_button_text') : esc_html__('Back To Home','xgenious');
