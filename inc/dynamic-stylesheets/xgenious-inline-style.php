...
$page_meta = Xgenious_Group_Fields_Value::page_container('xgenious','container_options');
...
$page_spacing_top = $page_layout_meta['page_spacing_top'] ?? '120';
$page_spacing_bottom = $page_layout_meta['page_spacing_bottom'] ?? '120';
...
$xgenious_inline_css = ob_get_clean();