...
if (!class_exists('Atttorg_Woocomerce_Customize')){
	class Atttorg_Woocomerce_Customize{
		//$instance variable
		...
		function woocommerce_header_add_to_cart_fragment( $fragments ) {
			...
			<a class="xgenious-header-cart" href="<?php echo wc_get_cart_url(); ?>"
			   title="<?php esc_attr_e( 'View your shopping cart','xgenious' ); ?>">
				<i class="fa fa-shopping-basket" aria-hidden="true"></i>
				<span class="cart-badge"><?php echo sprintf (  '%d', WC()->cart->get_cart_contents_count() ); ?></span>
			</a>
			<?php
			$fragments['a.xgenious-header-cart'] = ob_get_clean();
			return $fragments;
		}
        ...
        public function wc_product_post_class($class){
        	$class[] = is_product() ? 'xgenious-product-single-page-item' : 'xgenious-single-product-item';
            return $class;
        }
        /**
	...
	if ( class_exists('Atttorg_Woocomerce_Customize')){
		Atttorg_Woocomerce_Customize::getInstance();
	}
}