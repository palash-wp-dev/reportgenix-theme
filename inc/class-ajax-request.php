...
if ( ! class_exists( 'Xgenious_Ajax_Request' ) ) {
	class Xgenious_Ajax_Request {

		//$instance variable
		private static $instance;

		private function __construct() {
			add_action( 'wp_ajax_xgenious_item_support_mail', array( $this, 'item_support_mail_send' ) );
			add_action( 'wp_ajax_nopriv_xgenious_item_support_mail', array( $this, 'item_support_mail_send' ) );
...
//			add_filter( 'wp_mail_content_type', array( $this, 'set_html_content_type' ) );
 ...
 <body>
	...
	if ( class_exists( 'Xgenious_Ajax_Request' ) ) {
		Xgenious_Ajax_Request::getInstance();
	}
}
